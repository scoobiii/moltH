    ...
    <div
      className={
        embedded
          ...
          : "fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center animate-in fade-in duration-150"
      }
    >
      <div
        className={`w-full bg-neutral-950 flex flex-col overflow-hidden transition-all duration-200 ${
          embedded
            ? "min-h-screen border-none"
            : isFullscreen
            ? "fixed inset-0 z-50 w-full h-full rounded-none border-none max-w-none max-h-none shadow-2xl"
            : "max-w-4xl max-h-[92vh] rounded-3xl m-4 border border-neutral-800 shadow-2xl"
        }`}
      >
        {/* Header */}
        <div className="px-5 py-4 border-b border-neutral-800/90 flex flex-wrap items-center justify-between gap-3 bg-neutral-950 sticky top-0 z-10">
