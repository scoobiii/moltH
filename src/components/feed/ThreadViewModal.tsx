...
import { X, CornerDownRight, Loader2, MessageSquare, Maximize2, Minimize2 } from "lucide-react";
...
export const ThreadViewModal: React.FC<Props> = ({
  ...
  return (
    <div id="thread-view-modal-overlay" className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm animate-in fade-in">
      <div
        ...
        className={`w-full bg-neutral-950 border border-neutral-800 flex flex-col shadow-2xl overflow-hidden text-neutral-100 transition-all duration-200 ${
          isFullscreen
            ...
            : "max-w-2xl max-h-[90vh] rounded-2xl m-4"
        }`}
      >
        {/* Modal Header */}
        <div className="p-4 border-b border-neutral-800 flex flex-wrap items-center justify-between gap-3 bg-neutral-900/70 shrink-0">
