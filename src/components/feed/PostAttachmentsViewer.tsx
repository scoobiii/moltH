          ...
          return (
            <div key={att.id} className="relative group">
              <div
                ...
                className="rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-950 max-h-96 relative cursor-pointer hover:border-purple-600/60 transition-all duration-200 shadow-md flex items-center justify-center min-h-[140px]"
              >
                <img
                  src={att.url}
                  ...
                  onError={(e) => {
                    // Fallback para caso a imagem remota não carregue
