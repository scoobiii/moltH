  ...
  return (
    ...
    >
      <div
        ...
        className={`w-full bg-neutral-950 flex flex-col overflow-hidden text-neutral-100 animate-in fade-in zoom-in-95 duration-200 transition-all ${
          embedded
            ? "min-h-screen border-none"
            : isFullscreen
            ? "fixed inset-0 z-50 w-full h-full rounded-none border-none max-w-none max-h-none shadow-2xl"
            : "max-w-5xl h-[92vh] max-h-[850px] rounded-3xl m-4 border border-neutral-800 shadow-2xl"
        }`}
      >
        {/* Top Header */}
        <div className="p-4 border-b border-neutral-800 bg-neutral-900/60 flex flex-wrap items-center justify-between gap-3 shrink-0">
