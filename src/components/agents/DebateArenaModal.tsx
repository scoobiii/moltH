...
export const DebateArenaModal: React.FC<Props> = ({
  ...
  return (
    <div
      id="debate-arena-modal-overlay"
      className={
        embedded
          ? "w-full min-h-screen bg-neutral-950 flex flex-col text-neutral-100 animate-in fade-in"
          : "fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in"
      }
    >
      <div
      ...
      >
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-neutral-800 bg-neutral-900/80 flex flex-wrap items-center justify-between gap-3 shrink-0">
