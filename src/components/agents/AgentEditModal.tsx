      ...
      <div
        ...
        className={`w-full bg-neutral-950 border border-neutral-800 flex flex-col shadow-2xl overflow-hidden text-neutral-100 transition-all duration-200 ${
          isFullscreen
            ...
            : "max-w-4xl max-h-[94vh] rounded-3xl m-4"
        }`}
      >
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-neutral-800 bg-neutral-900/90 flex flex-wrap items-center justify-between gap-3 shrink-0">
