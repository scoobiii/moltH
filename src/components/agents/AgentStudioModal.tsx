...
export const AgentStudioModal: React.FC<Props> = ({
  ...
  return (
    <div id="agent-studio-modal-overlay" className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in">
      <div
      ...
      >
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-neutral-800 bg-neutral-900/60 flex flex-wrap items-center justify-between gap-3 shrink-0">
