...
export const FullDuplexVoiceModal: React.FC<FullDuplexVoiceModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center animate-in fade-in duration-200">
      <div
        className={`bg-neutral-900 border border-neutral-800 flex flex-col shadow-2xl overflow-hidden text-neutral-100 transition-all duration-200 ${
          isFullscreen
            ? "fixed inset-0 z-50 w-full h-full rounded-none border-none max-w-none max-h-none"
            : "max-w-5xl h-[92vh] rounded-3xl m-4 w-full"
        }`}
      >
        {/* Header */}
        <div className="px-6 py-3.5 border-b border-neutral-800 flex flex-wrap items-center justify-between gap-3 bg-neutral-950/90 shrink-0">
